...
@objcMembers public final class Topup: NSObject {
    ...
    public init(walletID: String, reference: Reference?, application: TopUpApplication?, metdata: Metadata?) {
    ...
    internal init(walletID: String, reference: Reference?, application: TopUpApplication?, metdata: Metadata?,id:String? = nil,created:Decimal? = 0,amount:Decimal?=0, currency:Currency? = nil, charge:TopupChargeModel? = nil, customer:Customer? = nil) {
        self.walletID = walletID
        self.reference = reference
        self.application = application
        self.metdata = metdata
...
extension Topup: Decodable {
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        self.init(walletID: walletID, reference: reference, application: application, metdata: metadata,id: id, created: created, amount: amount, currency: currency, charge: charge, customer: customer)
    }
}
