...
internal class UpdateChargeRequest: Encodable {
    ...
    internal convenience init(metadata: [String: String]?, descriptionText: String?, receiptSMS: String?, receiptEmail: String?) {
